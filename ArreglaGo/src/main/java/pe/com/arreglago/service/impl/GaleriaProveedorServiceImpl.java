...
public class GaleriaProveedorServiceImpl implements GaleriaProveedorService{
	...
	// Carpeta donde se guardarán las fotos. Debe existir en el sistema.
    private final String CARPETA_BASE = "C:/arreglago/galeria/";
    
 // ===================================
    // 🛑 MÉTODOS CRUD (Implementación Requerida por la Interfaz)
    // ===================================
    ...
    public List<GaleriaProveedorEntity> findAllCustom() {
        // Asumo que tienes un método custom para listar todos los activos
        return repositorio.findAll(); 
    }
    ...
    // ===================================
    // MÉTODOS ESPECÍFICOS DE GALERÍA
    // ===================================
    ...
    public GaleriaProveedorEntity addImagen(ProveedorEntity proveedor, String descripcion, MultipartFile archivo) throws IOException{
    	...
    	//Tu lógica para guardar el archivo físico y registrar en BD)
    	if (archivo == null || archivo.isEmpty()) {
            throw new IllegalArgumentException("El archivo de imagen no puede estar vacío.");
        }

        // 1. Procesar y Guardar Archivo Físico
        ...
        /*
         	Thumbnails.of(archivo.getInputStream())
                    ...
                    .toFile(destino);
         */
        // 🛑 CORRECCIÓN: Usar Files.copy() en lugar de transferTo o Thumbnails
        try (var inputStream = archivo.getInputStream()) {
            
            // Si no quieres redimensionar (porque Thumbnails falló)
            ...
            /* // Si QUIERES redimensionar, debes usar un archivo temporal:
            ...
            */
            ...
            // Loguea el error de IO para verificar permisos
            e.printStackTrace();
            throw new IOException("Error al escribir el archivo en disco: " + destino.getAbsolutePath(), e);
        }
    ...
    public void deleteImagen(Long idImagen) {
    	...
    	// Implementación de eliminación lógica ya definida
    	GaleriaProveedorEntity imagen = repositorio.findById(idImagen)
            .orElseThrow(() -> new RuntimeException("Imagen no encontrada"));
        
        imagen.setEstado(false); 
        repositorio.save(imagen); // <-- Aquí se guarda el cambio de estado, pero NO se retorna.
    }
